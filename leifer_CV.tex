...
\begin{listinline}
\item Agence Nationale de la Recherche (France), European Research Commission (EU),  Israel Science Foundation (Israel),  Medical Research Council (UK), National Institutes of Health (USA), National Science Foundation (USA),  NASA  (USA), Sir Henry Dale Wellcome Trust (UK), W.~M.~Keck Foundation (USA)
\end{listinline}
...
Nature Methods, Neuron, Philosophical Transactions of the Royal Society B, PLOS Biology, PLOS Computational Biology,
%PLoS One, 
...
NEU 457 (557) Measurement and Analysis of Neural Dynamics \dotfill Spring 2017, 2021\\
...
\section{Preprints}
\begin{bibsection}
\item Anne E.~Urai, Brent Doiron, Andrew M.~Leifer, Anne K. Churchland. ``Large-scale neural recordings call for new insights to link brain and behavior.'' \emph{arXiv}:2103.14662 (2021).

\item Xinwei Yu, Matthew S.~Creamer, Francesco Randi, Anuj K.~Sharma, Scott W.~Linderman, Andrew M.~Leifer, ``Fast deep learning correspondence for neuron tracking and identification in C.~elegans using synthetic training.'' \emph{arXiv}, 2101.08211, 21 January (2021).

\item Kelsey M.~Hallinen, Ross Dempsey, Monika Scholz, Xinwei Yu, Ashley N Linder, Francesco Randi, Anuj K Sharma, Joshua W. Shaevitz and Andrew M Leifer, ``Decoding locomotion from population neural activity in moving C. elegans'' \emph{bioRxiv}, 10.1101/445643, (2021).
...
\item Steven J.~Husson, Alexander Gottschalk, Andrew M.~Leifer, ``Optogenetic manipulation of neural activity in C. elegans: from synapse to circuits and behavior'' \emph{Journal of Biology of the Cell}, 105, 1--16 (2013).  \textbf{Invited review.}
