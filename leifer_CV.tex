...
\begin{listinline}
\item Nature Communications, Journal of Visual Experiments,  PLoS One and the conference CoSyNe.
\end{listinline}
...
Biophysics and Computations in Neurons and Networks, {\it Assistant Instructor}\dotfill Summers 2013\\
\\
...
Mid-Atlantic Society for Developmental Biology Regional Meeting \dotfill expected 2016\\
Yale University, Dept.~of Molecular Cellular \& Developmental Biology Seminar \dotfill expected 2016\\
Yale University School of Medicine, Department of Neuroscience Seminar \dotfill expected 2016\\
Stanford University School of Medicine, Department of Neurobiology Seminar \dotfill expected 2016\\
...
W.~Shaevitz, \textbf{Andrew M.~Leifer}, ``Whole-brain calcium imaging with cellular resolution in freely behaving \textit{C.
elegans}.'' \emph{Proceedings of the National Academy of Sciences,} \textbf{in press} (2015). 
