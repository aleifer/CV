...
Scientific content reviewer for:
\begin{list1}
\item Peer-reviewed journals: Journal of Visual Experiments and PLoS One
\item Academic conferences: CoSyNe
\item Funding programs:  NASA Postdoctoral Program and Sir Henry Dale Wellcome Trust Fellowship
\end{list1}
...
\item Mochi Liu, Quantitative and Computational Biology (jointly advised with Joshua Shaevitz)
\end{list1}
...
D.T.~Samuel, Mark J.~Alkema, ``Synaptic chain model for an escape response motor sequence.'' \textbf{(under review)}

\item Jeffrey Nguyen$^{*}$, Frederick B.~Shipley$^{*}$, Ashley N.~Linder, George Plummer, Joshua W.~Shaevitz, \textbf{Andrew M.~Leifer}, ``Whole-brain calcium imaging with cellular resolution in freely moving \textit{C. elegans}.''
