...
\begin{listinline}
\item Agence Nationale de la Recherhce (France), European Research Commission (EU),  Israel Science Foundation (Israel),  Medical Research Council (UK), National Institutes of Health (USA), National Science Foundation (USA),  NASA  (USA), Sir Henry Dale Wellcome Trust (UK), W.~M.~Keck Foundation (USA)
\end{listinline}
