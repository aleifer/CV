...
\begin{list1}
\item Mochi Liu (QCB, joint w/ Shaevitz); Xinwei Yu (Physics).
\end{list1}
...
\item Xiaowen Chen, Francesco Randi, \textbf{Andrew M Leifer} and William Bialek, ``Searching for collective behavior in a small brain.'' \emph{arXiv}, 1810.07623, October (2018).
\end{bibsection}
