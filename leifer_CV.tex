...
{\it Faculty}, Center for Physics of Biological Function\\
{\it Associated Faculty}, Lewis-Sigler Institute for Integrative Genomics \\
{\it Associated Faculty},  Bioengineering Initiative (2021--present)\\
\\
...
\begin{listinline}
\item  Equity, Diversity, and Inclusion (EDI) Advisor Board Member;  Chair of the Dicke Fellows Committee
\end{listinline}
...
\begin{listinline}
\item Chair of Seminar Series Committee; Biophysics Grad Admissions Committee; CPBF Fellow Search Committee
\end{listinline}
...
Freshman \& Sophomore Undergrad Advisor, Mathey College, Princeton University \dotfill 2020--2023\\
...
SPIA 548, Weapons of Mass Destruction and International Security \dotfill 2017--2019, 2022\\
...
\begin{list1}
\item Wayan Gauthey (NEU, joint w/ Murthy), Emily Osborne (PHY), Kevin Chen (NEU, joint w/ Pillow), Sophie Dvali, (PHY), Sandeep Kumar (NEU).
\end{list1}
...
%Albert Einstein School of Medicine October 18 2023
...
\item Kevin S.~Chen*, Rui Wu*, Marc H.~Gershow, and Andrew M.~Leifer. ``Continuous odor profile monitoring to study olfactory navigation in small animals.'' \textit{arXiv}, 2301.05905 Jan 14 (2023).
...
\item Francesco Randi, Anuj K.~Sharma, Sophie Dvali, Andrew M.~Leifer, ``Neural signal propagation atlas of C. elegans.'' \textit{arXiv},  2208.04790 Dec 22 (2022).
...
\item Francesco Rand and Andrew M.~ Leifer. ``Measuring and modeling whole-brain neural dynamics in Caenorhabditis elegans.'' \emph{Current Opinion in Neurobiology}. Vol 65, Pages 157-167 (2020). [Invited Review]
...
\begin{bibsection}
\item Ross Dempsey and Andrew M.~Leifer. \textit{Undergraduate Physics in a Hurry}. Princeton University Press. Expected 2026. 
\end{bibsection}
...
10/1/2017--9/30/2017 National Science Foundation, PHY-1734030 (PI: Bialek, co-PI: Shaevitz, named investigator: Leifer)\\
