...
Jadwin Hall, Room 206  \hfill Phone: (609) 258-8779 \\
...
\begin{listinline}
\item Dicke Fellowship selection committee, FPO examinar, Experimental Project examinaer, dissertation reader
\end{listinline}
...
APS March Meeting, Patterns \& Control in Animal Behavior \dotfill expected 2017\\
CUNY, The Graduate Center, Initiative for the Theoretical Sciences\dotfill  2016\\
Cornell University, Neurobiology \& Behavior Seminar, Invited by Grad Students\dotfill  2016\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Manuscripts Pre Peer-review}

\begin{bibsection}
\item Jeffrey Nguyen,  Ashley N.~Linder, George Plummer, Joshua
W.~Shaevitz, \textbf{Andrew M.~Leifer}, ``Automatically tracking neurons in a moving and deforming brain'' \emph{arXiv} 1610.04579, 14 Oct (2016).
\end{bibsection}
