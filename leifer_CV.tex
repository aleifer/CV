...
\begin{listinline}
\item Agence Nationale de la Recherhce (France), European Research Commission (EU),  Israel Science Foundation (Israel), National Science Foundation (USA),  NASA  (USA), Sir Henry Dale Wellcome Trust (UK), W.~M.~Keck Foundation (USA)
\end{listinline}
...
\begin{listinline}
\item Admissions committee,  Equity Diversity and Inclusion Committee Advisory Board, 
...
PHY 101 Introductory Physics I \dotfill Fall 2018\\
...
\begin{list1}
\item Xinwei Yu (Physics), Kevin Chen (NEU, joint w/ Pillow), Sophie Dvali, (Physics).
\end{list1}
