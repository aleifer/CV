...
Faculty Fellow, Mathey College, Princeton University\dotfill 2015\\
...
Program; Sir Henry Dale Wellcome Trust; European Research Commision.
\end{listinline}
...
Neurotechnologies and Analysis of Neural Datasets, {\it Faculty}\dotfill Summer 2015\\
...
\begin{list1}
\item Peter Johnson (Physics Junior Project); Jose Rico Chinchilla; Lukas Novak.
\end{list1}
\vspace{-1\baselineskip}\
\vspace{-1\baselineskip}\
...
Frontiers in Applied \& Computational Mathematics\dotfill expected 2016\\
