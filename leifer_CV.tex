...
{\it Associated Faculty}, Lewis-Sigler Institute for Integrative Genomics \\ % since 2016
{\it Associated Faculty},  Omenn-Darling Bioengineering Institute \\ %since 2021
\\
...
\begin{listinline}
\item    Chair of the Dicke Fellows Committee (PHY); Senior Committee (PHY); Junior Committee (PHY); Rising Stars in Physics Program Committee; Retreat Co-Organizer (NEU); Faculty Search Committee (Ommen-Darling Bioengineering Institute)
\end{listinline}
...
\begin{bibsection}
\item Sandeep Kumar, Anuj K Sharma, Andrew M Leifer, "An inhibitory acetylcholine receptor gates context dependent mechanosensory processing in C. elegans," bioRxiv 2024.03.21.586204, 27 March (2024).
...
\begin{bibsection}
\item Anuj Kumar Sharma, Francesco Randi, Sandeep Kumar, Sophie Dvali, Andrew M.~Leifer, ``TWISP: A Transgenic Worm for Interrogating Signal Propagation in C. elegans.'' \textit{Genetics} in press (2024).
