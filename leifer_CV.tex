...
\item Haoming He, Eugenia King Hin Fong, Sandeep Kumar, Ho Ming Terence Lee, Andrew M. Leifer, Martin Chalfie, Chaogu Zheng, ``Synaptic and neural pathway redundancy enables the robustness of a sensory-motor reflex and promotes predation escape in C. elegans,'' \textit{bioRxiv}, 2025.09.18.677212 19 September (2025).


			

\item Junang Li, Andrew M. Leifer, David H. Wolpert, ``Measuring amount of computation done by C. elegans using whole brain neural activity'' \textit{arXiv}, arxiv:2504.10300; 14 April (2025).
...
\item Wayan Gauthey, Albert Lin, Osama M. Ahmed, Andrew M. Leifer, Mala Murthy, Stephan Y. Thiberge, ``High-speed whole-brain imaging in Drosophila'' \textit{Nature Communications } in press (2026).
