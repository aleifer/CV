...
Allen Institute of Neural Dynamics (scheduled) \dotfill 2023\\
Harvard University, Department of Physics Colloquium (scheduled) \dotfill 2023\\
Memorial Sloan Kettering Cancer Center, Developmental Biology Seminar (scheduled) \dotfill 2023\\
...
\begin{bibsection}
\item Anuj Kumar Sharma, Francesco Randi, Sandeep Kumar, Sophie Dvali, Andrew M.~Leifer, ``TWISP: A Transgenic Worm for Interrogating Signal Propagation in C. elegans.'' \textit{bioRxiv} 2023.08.03.551820; 5 August (2023).

\end{bibsection}

\section{Peer-reviewed Publications}
\begin{bibsection}
\item Francesco Randi, Anuj K.~Sharma, Sophie Dvali, Andrew M.~Leifer, ``Neural signal propagation atlas of C. elegans.'' \textit{Nature}, in press (2023).

\item Sandeep Kumar,  Anuj K.~Sharma, Andrew Tran, Andrew M.~Leifer, ``Inhibitory motor signals gate mechanosensory processing in C. elegans'' \textit{PLOS Biology},  in press (2023).
