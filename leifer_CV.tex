...
%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Departmental Service (Current)} 
Department of Physics:
\begin{listinline}
\item Equity, Diversity and Inclusion Advisor Board Member;  Chair of the Dicke Committee; Senior Committee Member; Biophysics Seminar Series organizer
\end{listinline}
Princeton Neuroscience Institute:
\begin{listinline}
\item Retreat Co-organizer; Admissions Committee; Bezos Center Steering Committee
\end{listinline}

\section{Departmental Service (Previous)}
\begin{listinline}
\item Junior Committee; Rising Stars in Physics Program Committee; 
\end{listinline}


\section{University Service}
Faculty Advisor, Mathey College, Princeton University\dotfill 2020-2021\\
...
Program Committee member, CoSyNe\dotfill 2019-2021\\
...
% NIH Special emphasis panel: Study section Neuroimaging and Low Vision Technologies
Grant reviewer for funding agencies and foundations including:
\begin{listinline}
\item Agence Nationale de la Recherhce (France), European Research Commission (EU),  Israel Science Foundation (Israel),  National Institutes of Health (USA), National Science Foundation (USA),  NASA  (USA), Sir Henry Dale Wellcome Trust (UK), W.~M.~Keck Foundation (USA)
\end{listinline}
Scientific content reviewer for peer-reviewed journals including:
\begin{listinline} 
\item %Current Opinions in Systems Biology, 
eLife, %Integrative Biology, Journal of Neuroscience Methods, 
Journal of Physical Biology, 
%Journal of Visual Experiments, 
%Nature Communications, 
Nature Methods, Neuron, Philosophical Transactions of the Royal Society B, PLOS Biology, 
%PLoS One, 
...
PHY 101 Introductory Physics I \dotfill Fall 2018, 2020\\
PHY 103 General Physics I, \dotfill Fall 2016, 2019\\
NEU 422 Neural Dynamics of Cognition \dotfill Fall 2017\\
NEU 457/557 Measurement and Analysis of Neural Dynamics, \dotfill Spring 2017\\
...
NEU 501,502 Neuroscience: from molecules to systems and behavior \dotfill 2017--2020\\
...
\begin{list1}
\item Xinwei Yu (PHY), Kevin Chen (NEU, joint w/ Pillow), Sophie Dvali, (PHY), Sandeep Kumar (NEU).
\end{list1}
\vspace{-1\baselineskip}
PhD Students (past):
\begin{list1}
\item  Ashley Linder (Neuroscience, joint w/ Shaevitz), Mochi Liu (QCB, joint w/ Shaevitz)
\end{list1}
...
\begin{list1}
\item Milena Chakraverti-Wuerthwein (Physics, JP and Senior Thesis), John Li (Neuroscience, Senior Thesis), Alicia Castillo (NEU, Senior Thesis), Xiaoting Sun;  David Mazumder (Molecular Biology); Kevin Mizes (Physics Senior Thesis; Treiman Fellow; Sanda \& Jeremiah Lambert '55 Undergraduate Neuroscience Research Award Recipient), Peter Johnson (Physics Junior Project); Jose Rico Chinchilla; Lukas Novak.
\end{list1}
\vspace{-1\baselineskip}\
\vspace{-1\baselineskip}\
...
\section{Preprints}
\begin{bibsection}
\item Xinwei Yu, Matthew S.~Creamer, Francesco Randi, Anuj K.~Sharma, Scott W.~Linderman, \textbf{Andrew M.~Leifer}, ``Fast deep learning correspondence for neuron tracking and identification in C.~elegans using synthetic training.'' \emph{arXiv}, 2101.08211, 21 January (2021).

\item Kelsey M.~Hallinen, Ross Dempsey, Monika Scholz, Xinwei Yu, Ashley N Linder, Francesco Randi, Anuj K Sharma, Joshua W. Shaevitz and \textbf{Andrew M Leifer}, ``Decoding locomotion from population neural activity in moving C. elegans'' \emph{bioRxiv}, 10.1101/445643, (2021).

\item Francesco Randi and \textbf{Andrew M Leifer}, ``Nonequilibrium Green's functions for functional connectivity in the brain.'' \emph{arXiv}, 2008.06093, 13 August (2020).

\item Princeton Open Ventilation Monitor Collaboration, Philippe Bourrianne, Stanley Chidzik, Daniel J Cohen, Peter Elmer, Thomas Hallowell, Todd J Kilbaugh, David Lange, \textbf{Andrew M Leifer}, Daniel R. Marlow, Peter D. Meyers, Edna Normand, Janine Nunes, Myungchul Oh, Lyman Page, Talmo Pereira, Jim Pivarski, Henry Schreiner, Howard A Stone, David W Tank, Stephan Thiberge, Christopher Tully.  Inexpensive multi-patient respiratory monitoring system for helmet ventilation during COVID-19 pandemic. \emph{medRxiv},    10.1101/2020.06.29.20141283  (2020). \emph{corresponding author}.
...
\item Francesco Rand and \textbf{Andrew M.~ Leifer}. ``Measuring and modeling whole-brain neural dynamics in Caenorhabditis elegans.'' Current Opinion in Neurobiology. Vol 65, Pages 157-167 (2020).

\item Robert Datta, David Anderson, Kristen Branson, Pietro Perona, and \textbf{Andrew Leifer}, ``Computational neuroethology: a call to action.'' \emph{Neuron}, 104:1, (2019).

\item Xiaowen Chen, Francesco Randi, \textbf{Andrew M Leifer} and William Bialek, ``Searching for collective behavior in a small brain.'' \emph{Phys Rev E} \textbf{99}, 052418 (2019).


\item Mochi Liu, Anuj K.~Sharma, Joshua W.~Shaevitz, \textbf{Andrew M.~Leifer}, ``Temporal processing and context dependency in \textit{C. elegans} mechanosensation.'' \emph{eLife}, 7:e36419 (2018).   

\item Jeffrey Nguyen,  Ashley N.~Linder, George Plummer, Joshua
W.~Shaevitz, \textbf{Andrew M.~Leifer}, ``Automatically tracking neurons in a moving and deforming brain'' \emph{Plos Computational Biology}, 13(5): e1005517 (2017).
	
\item Jeffrey Nguyen$^{*}$, Frederick B.~Shipley$^{*}$, Ashley N.~Linder, George Plummer, Mochi Liu, Sagar U. Setru, Joshua
W.~Shaevitz, \textbf{Andrew M.~Leifer}, ``Whole-brain calcium imaging with cellular resolution in freely behaving \textit{Caenorhabditis elegans}.'' \emph{Proceedings of the National Academy of Sciences,}  vol.~113 no.~8, E1074-E1081 (2016). 
...
5/15/2020--4/30/2021 National Science Foundation, 2013509, (co-PI: Leifer; PI: Elmer)\\
...
7/2017--7/2022, Simons Foundation, Simons Collaboration on the Global Brain (co-PI Leifer; contact PI is Zimmer) \\
...
7/2014--7/2017, Simons Foundation, Simons Collaboration on the Global Brain  (PI: Leifer) \\
