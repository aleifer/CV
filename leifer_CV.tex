...
\end{listinline}
Service in the Department of Physics and PNI including:
\begin{listinline}
\item Admissions committee (NEU),  Equity Diversity and Inclusion Committee Advisory Board (PHY), 
 retreat co-organizer (NEU), Juniors committee (PHY), Chair, Dicke Committee (PHY), Biophysics seminar organizer, prelim grader, Experimental Project examiner, junior and senior thesis reader and examiner.
\end{listinline}
