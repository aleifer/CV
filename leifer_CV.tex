...
%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Departmental or Unit-level Service (AY 2025-2026)} 
Department of Physics:
\begin{listinline}
\item  Chair of Equity, Diversity, and Inclusion (EDI) Advisory Board (Spring)
\end{listinline}
Princeton Neuroscience Institute:
\begin{listinline}
\item  Chair of Neuroscience Graduate Admissions Committee
\end{listinline}
Center for Physics of Biological Function:
\begin{listinline}
\item Chair of Biophysics Graduate Admissions Committee
\end{listinline}



\section{Departmental  or Unit-Level Service (Previous)}
\begin{listinline}
\item    Chair of Equity, Diversity and Inclusion Advisor Board (PHY), Chair of the Dicke Fellows Committee (PHY); EDI Committee (PHY); Senior Committee (PHY); Junior Committee (PHY); Rising Stars in Physics Program Committee; Retreat Co-Organizer (NEU); Faculty Search Committee (Ommen-Darling Bioengineering Institute)
\end{listinline}


\section{University Service (Princeton)}
Faculty Advisory Committee, Office of Information Technology \dotfill 2026--Present\\ 
Biological Agent Safety Committee,\dotfill 2025--Present\\
Institutional Biosafety Committee, \dotfill 2021--Present\\ 
Undergrad Advisor, Mathey College \dotfill 2020--present\\
Member, Council of the Princeton University Community\dotfill 2013-2014


\section{University Service (Previous)}
...
Member, Panel on Public Affairs, American Physical Society\dotfill 2026-present\\
Member-at-Large, Division of Biological Physics, American Physical Society\dotfill    2025-present\\
Co-organizer, \textit{CeNeuro} conference, to be held in France 2026\dotfill 2024-present\\
Co-organizer Physics of Neural Systems sessions, 2025 APS Meeting \dotfill 2024-2025\\
...
\end{listinline}
Ad-hoc Editor: \textit{eLife, PNAS}


%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Teaching}
Princeton University, {\it Faculty}:\\
PHY 104 General Physics II \dotfill S2026\\
NEU 457 (557) Measurement and Analysis of Neural Dynamics \dotfill S2017, S2021, F2023, F2025\\
PHY 108 Physics for Life Scientists \dotfill S2024\\
PHY 101 Introductory Physics I \dotfill F2018, F2020-22\\
PHY 103 General Physics I \dotfill F2016, F2019\\
NEU 422 Neural Dynamics of Cognition \dotfill F2017\\
...
NEU 501,502 Neuroscience: from molecules to systems and behavior \dotfill 2017--2025\\
...
\begin{list1}
\item Pearl Thijssen (PHY), Wayan Gauthey (NEU, joint w/ Murthy), Emily Osborne (PHY).
\end{list1}
\vspace{-1\baselineskip}
PhD Students (past):
\begin{list1}
\item  Sophie Dvali (PHY), Sandeep Kumar (NEU), Kevin Chen (NEU, joint w/ Pillow), Xinwei Yu (PHY),  Ashley Linder (Neuroscience, joint w/ Shaevitz), Mochi Liu (QCB, joint w/ Shaevitz)
\end{list1}

Undergraduate Students (current):
\begin{list1}
\item    Jatavian Butler (NEU, Junior Project)
\end{list1}
\vspace{-\baselineskip}

Undergraduate Students (past):
\begin{list1}
\item Anna Borodianski (NEU, Senior Thesis),  Abdul-Bassit Fijabi (NEU, Senior Thesis), Andrew Tan (NEU, Senior Thesis), Tori Edington (PHY, Senior Thesis),  Milena Chakraverti-Wuerthwein (PHY, JP and Senior Thesis), John Li (NEU, Senior Thesis), Alicia Castillo (NEU, Senior Thesis), Xiaoting Sun;  David Mazumder (MOL); Kevin Mizes (PHY, Senior Thesis; Treiman Fellow; Sanda \& Jeremiah Lambert '55 Undergraduate Neuroscience Research Award Recipient), Peter Johnson (PHY, Junior Project); Miloš Nikolič (PHY, Junior Project);  Jose Rico Chinchilla; Lukas Novak.
\end{list1}
\vspace{-1\baselineskip}\
\vspace{-1\baselineskip}\
...
Neural Basis of Natural Behaviors, Athens, Greece \dotfill 2026\\
Simons Foundation, Flatiron Institute, Information Processing in Biological Networks   \dotfill 2026\\
American Physical Society, Global Physics Summit, PRX Life Session \dotfill 2026\\
Kavli Institute for Theoretical Physics, Neurophysics of Active Sensing \dotfill 2025\\
HHMI Janelia, Analysis and Modeling of Connectomes \dotfill 2025\\
École Polytechnique Fédérale de Lausanne \dotfill 2025\\
Université Claude Bernard Lyon 1, Mechanisms in Integrated Life Sciences \dotfill 2025\\
Simons Foundation SCGB Annual Meeting \dotfill 2025\\
Salk Institute \dotfill 2025\\
Scripps Research, Neuroscience Seminar \dotfill 2025\\
Harvard University, Program in Biophysics \dotfill 2025\\
Yale University, Inspiring Speaker Seminar, Wu Tsai Institute\dotfill 2025\\
Automated Neural Identification, Tracking, and Behavioral Conference, UMass Worcester \dotfill 2024\\
Columbia University, Kavli Seminar, Center for Theoretical Neuroscience \dotfill 2024\\
Duke University, Department of Neurobiology \dotfill 2024\\
...
Mid-Atlantic Society for Developmental Biology, Howard University \dotfill  2016\\
...
University of Paris Descartes, Optics and Photonics Seminar \dotfill 2012\\
...
\item Alison Kochersberger, Dongyeop Lee, Mohammad Mahdi Torkashvand, Sandeep Kumar, Saba Baskoylu, Titas Sengupta, Noelle Koonce, Chloe E. Emerson, Nandan V. Patel, Daniel Colón-Ramos, Steven Flavell, Andrew M. Leifer, Vivek Venkatachalam, H. Robert Horvitz, Marc Hammarlund, ``Programmed Cell Death Modifies Neural Circuits and Tunes Intrinsic Behavior.'' \textit{bioRxiv}, 2023.09.11.557249 November 19 (2025).

\item Matthew S Creamer, Andrew M Leifer, Jonathan W Pillow, ``Bridging the gap between the connectome and whole-brain activity in C. elegans,'' \textit{bioRxiv}, 2024.09.22.614271(2024).

\end{bibsection}

\section{Peer-reviewed Publications}
\begin{bibsection}
 \item Kevin S. Chen, Jonathan W. Pillow*, Andrew M. Leifer*, ``State-switching navigation strategies in C. elegans are beneficial for chemotaxis,''  \textit{Proceedings of the National Academies of Science}, 123 (25) e2519999123, 23 June (2026).

\item Junang Li, Yuzheng Lin, Anuj Kumar Sharma, Andrew M. Leifer, David H. Wolpert, ``Estimating the amount of computation done by a brain using population neural activity'' \textit{Proceedings of the National Academies of Science}, 123 (25) e2507932123, 23 June (2026).

\item Haoming He, Eugenia King Hin Fong, Sandeep Kumar, Ho Ming Terence Lee, Andrew M. Leifer, Martin Chalfie, Chaogu Zheng, ``Synaptic and neural pathway redundancy enables the robustness of a sensory-motor reflex and promotes predation escape in C. elegans,'' \textit{Proceedings of the National Academies of Science}, 123 (22) e2531407123, 26 May (2026).

\item Wayan Gauthey, Albert Lin, Osama M. Ahmed, Andrew M. Leifer, Mala Murthy, Stephan Y. Thiberge, ``High-speed whole-brain imaging in Drosophila'' \textit{Nature Communications} 17, 5810, 28 April (2026).


\item Tiannuo Li*, Sandeep Kumar*, Hoikiu Poon, Andrew M Leifer, Chaogu Zheng, ``Functional Interrogation of Neuronal Subtypes via Intersectional Expression of Optogenetic Actuator Reveals Non-linear Components in a Linear Circuit'' \textit{Cell Reports}. 44, 10; 28 October (2025).

\item Sophie Dvali, Caio Seguin, Richard Betzel, Andrew M. Leifer, ``Diverging network architecture of the C. elegans connectome and signaling network'' \textit{PRX Life},  3, 033021; 3 Sept (2025). 


\item Rizwanul Haque, Hagar Setty, Ramiro Lorenzo, Gil Stelzer, Ron Rotkopf, Yehuda Salzberg, Gal Goldman, Sandeep Kumar, Shiraz Nir Halber, Andrew M. Leifer, Elad Schneidman, Patrick Laurent, Meital Oren-Suissa,  ``Decoding sexual dimorphism of the sex-shared nervous system at single-neuron resolution.'' \textit{Science Advances} 11,eadv9106  11 July (2025). 
 

\item Kevin S. Chen, Anuj K. Sharma, Jonathan W. Pillow, Andrew M. Leifer, ``Navigation strategies in Caenorhabditis elegans are differentially altered by learning,'' \textit{PLOS Biology}, 23(3): e3003005, (2025).
...
\section{Commentary}
\begin{bibsection}
\item Andrew Leifer,  Thierry Emonet, Andrea Liu and Sidney Robert Nagel. ``American science needs an executive branch constrained by checks and balances.'' \emph{Nature Physics},  22, 1364–1365 (2026). 

\item Andrew M. Leifer, Andrea J. Liu and Sidney R. Nagel, ``US researchers must stand up to protect freedoms, not just funding.'' \emph{Nature} 641, 592–593 (2025).
\end{bibsection}
...
7/2026--7/2034 Wellcome Trust (lead-PI: Schafer; co-PI: Beets, Giles, Leifer)\\
``Dynamics and plasticity of neuropeptidergic circuits''\\
Total Direct \& Indirect Costs: \pounds4,750,000\\



12/2024--12/2027 Keck Foundation (lead-PI: Leifer; co-PI: Murthy, Tank, Seung)\\
``Technology for measuring neural signal propagation at brain scale''\\
Total Direct \& Indirect Costs: \$1,200,000\\
