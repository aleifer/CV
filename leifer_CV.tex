...
Program Committee member, CoSyne\dotfill 2019\\
...
\begin{listinline} %Add in Nature Physics
\item PNAS, Nature Communications, PLOS Biology, Scientific Reports, Philosophical Transactions of the Royal Society B,  Integrative Biology, Current Opinions in Systems Biology, Journal of Physical Biology, Journal of Neuroscience Methods,  Journal of Visual Experiments,  PLoS One and the conference CoSyNe.
\end{listinline}
...
\end{listinline}
Departmental service including:
\begin{listinline}
\item Admissions committee, Juniors committee, Dicke Fellowship selection committee, Biophysics seminar organizer, prelim grader, FPO examiner, Experimental Project examiner, dissertation reader.
\end{listinline}
...
PHY 103 General Physics I, \dotfill Fall 2016\\
...
Neurotechnologies and Analysis of Neural Datasets, \dotfill Summers 2015--2017\\
\\
Princeton University, {\it Guest Lecturer}:\\
NEU 501,502 Neuroscience: from molecules to systems to behavior \dotfill 2017--2018\\
Woodrow Wilson School 548, Weapons of Mass Destruction and International Security \dotfill 2017--2018\\
...
\begin{list1}
\item Mochi Liu (QCB, joint w/ Shaevitz); Xinwei Yu (Physics), Kevin Chen (NEU, joint w/ Pillow).
\end{list1}
\vspace{-1\baselineskip}
PhD Students (past):
\begin{list1}
\item  Ashley Linder (Neuroscience, joint w/ Shaevitz).
\end{list1}

Undergraduate Students (current):
\begin{list1}
\item John Li (Neuroscience, Senior Thesis), Milena Chakraverti-Wuerthwein (Physics, Junior Project).
\end{list1}
\vspace{-\baselineskip}

Undergraduate Students (past):
\begin{list1}
\item Alicia Castillo (NEU, Senior Thesis), Xiaoting Sun;  David Mazumder (Molecular Biology); Kevin Mizes (Physics Senior Thesis; Treiman Fellow; Sanda \& Jeremiah Lambert '55 Undergraduate Neuroscience Research Award Recipient), Peter Johnson (Physics Junior Project); Jose Rico Chinchilla; Lukas Novak.
\end{list1}
\vspace{-1\baselineskip}\
\vspace{-1\baselineskip}\
...
%NIH BRAIN Initiative Investigators Meeting \dotfill 2019\\
...
\section{Preprints}
\begin{bibsection}
\item Monika Scholz, Ashley N Linder, Francesco Randi, Anuj K Sharma, Xinwei Yu, Joshua W. Shaevitz and \textbf{Andrew M Leifer}, ``Predicting natural behavior from whole-brain neural dynamics'' \emph{bioRxiv}, 10.1101/445643, October (2018).
\end{bibsection}

\section{Peer-reviewed Publications}
\begin{bibsection}
\item Xiaowen Chen, Francesco Randi, \textbf{Andrew M Leifer} and William Bialek, ``Searching for collective behavior in a small brain.'' \emph{Phys Rev E}, in press (2019). [Preprint available at arXiv:1810.07623].
...
Total Direct \& Indirect Costs: \$ 500,000\\\ %Andy double check the exact numbers


7/2017--7/2022, Simons Foundation, Simons Collaboration on the Global Brain (co-PI; contact PI is Zimmer) \\
