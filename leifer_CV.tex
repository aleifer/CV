...
\begin{listinline}
\item European Research Commission (EU),  Israel Science Foundation (Israel), National Science Foundation (USA),  NASA  (USA), Sir Henry Dale Wellcome Trust (UK), W.~M.~Keck Foundation (USA)
\end{listinline}
...
\begin{listinline}
\item Admissions committee, retreat co-organizer, Juniors committee, Dicke Fellowship selection committee, Biophysics seminar organizer, prelim grader, Experimental Project examiner, junior and senior thesis reader and examiner.
\end{listinline}
...
NEU 501,502 Neuroscience: from molecules to systems and behavior \dotfill 2017--2019\\
