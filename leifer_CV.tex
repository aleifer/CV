...
\begin{listinline}
\item PNAS, PLOS Biology, Journal of Neuroscience Methods, Nature Communications, Journal of Physical Biology, Journal of Visual Experiments,  PLoS One and the conference CoSyNe.
\end{listinline}
...
NEU 501 Neuroscience: from molecules to systems to behavior \dotfill 2017\\
...
\begin{list1}
\item Alicia Castillo (Neuroscience, Senior Thesis). 
\end{list1}
\vspace{-\baselineskip}
